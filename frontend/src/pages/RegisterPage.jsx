...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        const { token, username, fullName } = res.data.data;
        loginUser(token, { username, fullName });
        navigate('/dashboard');
      } else {
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-5xl font-bold leading-tight mb-4">
                Start applying <br />
                <span className="bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">in minutes.</span>
              </h1>
              <p className="text-slate-300 text-lg max-w-md">
                Join thousands of job seekers who let AI handle grunt work of applications.
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-2xl border border-white/20 rounded-2xl shadow-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="mb-8">
                  ...
                  <p className="text-slate-300 mt-2">Free to start. No credit card required.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="inline-flex items-center justify-center rounded-lg text-sm font-medium transition-all disabled:opacity-50 bg-gradient-to-r from-red-600 to-red-500 text-white hover:from-red-500 hover:to-red-400 h-11 px-4 py-2 w-full shadow-lg shadow-red-500/30 mt-2"
                  >
